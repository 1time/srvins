...
public Action:Event_PlayerHurt(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if((nArmorItemID != nArmorFireResistance) && ((StrEqual(sWeapon, "grenade_molotov")) || (StrEqual(sWeapon, "grenade_anm14")) || (StrEqual(sWeapon, "grenade_m203_incid")) || (StrEqual(sWeapon, "grenade_gp25_incid")) || (StrEqual(sWeapon, "grenade_m79_napalm"))
        || (StrEqual(sWeapon, "grenade_m203_incendiary")) || (StrEqual(sWeapon, "grenade_gp25_incendiary")) || (StrEqual(sWeapon, "grenade_m79_incen"))))
	{
